...
These two datasets are `SpatialPolygonsDataFrame`s constructed with the `sp` package.  This means
...
As well, use something like Guerry's pallete, where dark = Worse.
