...
* __dimension reduction plots__ : plot representations of the data projected into a space of fewer dimensions than the number of variables in the data set.
...
To see the relations among more than two variables we could turn to a
