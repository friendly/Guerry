...
The panels in the
upper and lower triangles can be rendered differently, as shown below.

![](../man/figures/corrgram-renderings.png)
...
An important feature of corrplots is that they accommodate a large number of variables.
Here I show the correlations among _all numeric_ variables, using `corrplot.mixed`
from the `corrplot` package. This provides for _effect ordering_ [@FriendlyKwan:02:effect] 
of the variables in a way that puts the most highly correlated variables adjacently,
making it easier to see their patterns.
