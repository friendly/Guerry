...
```{r guerry-instruction-map, echo=FALSE, out.width="60%", fig.align="center"}
...
The historically low-literacy departments of Brittany and central France stand
out as the darkest; the generally more literate northeast is lightest -- the same
departments that are darkest in Guerry's own hand-tinted map above.
