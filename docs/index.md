...
![](reference/figures/Guerry-vars.png)
...
![](reference/figures/README-gfrance1-1.png)
...
![](reference/figures/README-gfrance2-1.png)
...
![](reference/figures/README-gfrance3-1.png)
...
![](reference/figures/README-gfrance4-1.png)
...
gets the (X, Y) coordinates of the centroids for each department, and
[`text()`](https://rdrr.io/r/graphics/text.html) for the `sp` object
plots the labels.
...
![](reference/figures/README-gfrance85-labels-1.png)
...
![](reference/figures/README-ex-bivar1-1.png)
...
![](reference/figures/README-ex-bivar2-1.png)
