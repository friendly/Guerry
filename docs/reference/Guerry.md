...
- `Crime_pers`:
  ...
  Population per Crime against persons. Source: A2 (Comptes general,
  1825-1830)
...
- `Clergy`:
  ...
  priests in active service / population. Source: A1 (Almanach officiel
  du clergy, 1829)
...
- `Donation_clergy`:
  ...
  donations inter vivios to population– Average for the years 1815-1824.
...
Dray, S., & Jombart, T. (2011). Revisiting Guerry's data: Introducing
spatial constraints in multivariate analysis. *Annals of Applied
Statistics*, **5**, 2278-2299
...
<https://www.datavis.ca/gallery/guerry/guerrydat.html>.
